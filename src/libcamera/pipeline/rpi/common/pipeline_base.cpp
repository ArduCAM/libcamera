					...
					MediaDevice *backend, MediaEntity *sensorEntity)
{
	...
	if (data->sensor_->model() == "arducam-pivariety") {
		// Since the "arducam-pivariety" camera needs to obtain 
		// sensorDelays information from the camera, 
		// we restore the previous method to obtain delays.
		params = {
